    ...
    <div>
      ...
      <div className="d-filters">
        <div className="d-search-wrap">
          <svg className="d-search-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#6b7280" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              {loading ? (
                ...
                filtered.map((entry) => (
                  <tr key={entry.date}>
                    ...
                    <td>
                      {entry.version ? (
                        <span className="d-badge" style={{ color: "#F17F0D", background: "rgba(241,127,13,0.12)", border: "1px solid rgba(241,127,13,0.3)" }}>
                          {entry.version}
                        </span>
                      ) : (
