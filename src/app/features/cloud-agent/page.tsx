                ...
                >
                  ...
                  <div className={isEven ? "" : "lg:order-1"}>
                    <Image
                      src={`/assets/${
                        [
                          "feature1-parallel-agents.gif",
                          "feature2-live-terminal.gif",
                          "feature3-codebase-mapping.gif",
                          "feature4-end-to-end.gif",
                          "feature5-auto-pr.png",
                          "feature6-reviewer-comments.png",
                        ][i]
                      }`}
                      alt={s.title}
                      width={700}
