  ...
  return (
    <>
      ...
      <main id="main-content" style={{ paddingTop: 80 }}>
        {/* Hero */}
        <section style={{ background: "var(--bg-page)", padding: "80px 24px 40px", textAlign: "center" }}>
        ...
        <section style={{ background: "var(--bg-page)", padding: "0 24px 32px" }}>
          <div style={{ maxWidth: 720, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))", gap: 12 }}>
            {contactMethods.map((m) => (
              <div key={m.title} style={{ background: "var(--bg-surface)", border: "1px solid var(--border-primary)", borderRadius: 10, padding: "16px 14px", textAlign: "center" }}>
                ...
                {m.href ? (
                  ...
                  <p style={{ color: "var(--text-secondary)", fontSize: 12, fontWeight: 600, margin: 0 }}>{m.detail}</p>
                )}
        ...
        {/* FAQ */}
        <section style={{ background: "var(--bg-page)", padding: "60px 24px 80px" }}>
          <div style={{ maxWidth: 700, margin: "0 auto" }}>
            ...
            {[
              ...
              <div key={faq.q} style={{ borderBottom: "1px solid var(--border-primary)", padding: "20px 0" }}>
