      ...
      <main id="main-content" style={{ paddingTop: 80 }}>
        ...
        >
          <div style={{ maxWidth: 800, margin: "0 auto" }}>
            ...
            >
              <span style={{ color: "var(--accent)" }}>Figma</span> Integration
            </h1>
            <p
              style={{
                color: "var(--text-soft)",
