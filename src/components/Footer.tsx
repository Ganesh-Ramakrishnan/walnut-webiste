        ...
        <div className="ft-top">
          ...
          <div className="ft-brand">
            ...
            <div className="ft-socials">
              <a href="https://discord.gg/Tcw88yu6q" target="_blank" rel="noopener noreferrer" className="ft-social" aria-label="Discord">
              ...
              <a href="https://www.instagram.com/meet_walnutai.ai?igsh=OWVoM2hra2RyaDhu" target="_blank" rel="noopener noreferrer" className="ft-social" aria-label="Instagram">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://www.linkedin.com/company/wal-nut/" target="_blank" rel="noopener noreferrer" className="ft-social" aria-label="LinkedIn">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
