...
const footerLinks = {
  PRODUCT: ["Outcomes", "How it Works", "Results", "Pricing"],
      ...
      <div className="ft-container">
        ...
        <div className="ft-top">
          ...
          <div className="ft-brand">
            <a href="#home" className="ft-logo-link">
              <img src="/assets/walnut-logo.svg" alt="Walnut" className="ft-logo-img" />
            </a>
            <p className="ft-brand-desc">
              Stop shipping bugs. Starts shipping with confidence
            </p>
          </div>
        ...
        <div className="ft-bottom">
          <p className="ft-copyright">
            &copy; 2024 Walnut. All rights reserved.
          </p>

          <a href="#" className="ft-legal">Privacy Policy</a>
          <a href="#" className="ft-legal">Terms &amp; Condition</a>

          <div className="ft-socials">
            <a href="#" className="ft-social" aria-label="Discord">
